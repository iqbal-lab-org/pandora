...
LocalNode::LocalNode (string s, Interval p, uint32_t i): seq(s), pos(p), id(i), covg(0)//, num_minis(0), supported_by_reads(false), supported_in_deg(0), supported_out_deg(0) {}

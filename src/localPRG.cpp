...
void LocalPRG::write_aligned_path_to_fasta(const string &filepath, const vector<LocalNode *> &lmp,
...
void LocalPRG::add_sample_to_vcf(VCF &vcf, const vector<LocalNode *> &rpath, const vector<LocalNode *> &sample_path,

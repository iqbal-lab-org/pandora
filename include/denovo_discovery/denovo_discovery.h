...
namespace denovo_discovery {
    void find_candidates(const std::set<std::pair<ReadCoordinate, GeneIntervalInfo>> &candidate_coordinates,
                         const std::string &reads_filepath, const fs::path &output_directory, const double &error_rate,

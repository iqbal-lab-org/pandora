...
class KmerGraph {
  ...
  public:
    ...
    void find_all_compatible_paths(std::vector<std::deque<KmerNodePtr>>&, std::vector<std::vector<std::pair<uint16_t, uint16_t>>>&, const uint8_t read_share_thresh=10, const uint8_t covg_thresh=30);

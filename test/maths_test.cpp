...
protected:
    void SetUp() override {
        ...
        one_sized_vector_int.insert(one_sized_vector_int.end(), four_sized_vector_int.begin(), four_sized_vector_int.begin()+1);
        two_sized_vector_int.insert(two_sized_vector_int.end(), four_sized_vector_int.begin(), four_sized_vector_int.begin()+2);
        three_sized_vector_int.insert(three_sized_vector_int.end(), four_sized_vector_int.begin(), four_sized_vector_int.begin()+3);
        ...
        one_sized_vector_double.insert(one_sized_vector_double.end(), four_sized_vector_double.begin(), four_sized_vector_double.begin()+1);
        two_sized_vector_double.insert(two_sized_vector_double.end(), four_sized_vector_double.begin(), four_sized_vector_double.begin()+2);
        three_sized_vector_double.insert(three_sized_vector_double.end(), four_sized_vector_double.begin(), four_sized_vector_double.begin()+3);
...
TEST_F(MathsTest___all_methods___Fixture, sum___one_sized_vector_int) {
    uint32_t actual = Maths::sum(one_sized_vector_int.begin(), one_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, sum___two_sized_vector_int) {
    uint32_t actual = Maths::sum(two_sized_vector_int.begin(), two_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, sum___one_sized_vector_double) {
    double actual = Maths::sum(one_sized_vector_double.begin(), one_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, sum___two_sized_vector_double) {
    double actual = Maths::sum(two_sized_vector_double.begin(), two_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, mean___one_sized_vector_int) {
    uint32_t actual = Maths::mean(one_sized_vector_int.begin(), one_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, mean___two_sized_vector_int) {
    uint32_t actual = Maths::mean(two_sized_vector_int.begin(), two_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, mean___four_sized_vector_int) {
    uint32_t actual = Maths::mean(four_sized_vector_int.begin(), four_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, mean___one_sized_vector_double) {
    double actual = Maths::mean(one_sized_vector_double.begin(), one_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, mean___two_sized_vector_double) {
    double actual = Maths::mean(two_sized_vector_double.begin(), two_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, mean___four_sized_vector_double) {
    double actual = Maths::mean(four_sized_vector_double.begin(), four_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___one_sized_vector_int) {
    uint32_t actual = Maths::median(one_sized_vector_int.begin(), one_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___two_sized_vector_int) {
    uint32_t actual = Maths::median(two_sized_vector_int.begin(), two_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___three_sized_vector_int) {
    uint32_t actual = Maths::median(three_sized_vector_int.begin(), three_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___four_sized_vector_int) {
    uint32_t actual = Maths::median(four_sized_vector_int.begin(), four_sized_vector_int.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___one_sized_vector_double) {
    double actual = Maths::median(one_sized_vector_double.begin(), one_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___two_sized_vector_double) {
    double actual = Maths::median(two_sized_vector_double.begin(), two_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___three_sized_vector_double) {
    double actual = Maths::median(three_sized_vector_double.begin(), three_sized_vector_double.end());
...
TEST_F(MathsTest___all_methods___Fixture, median___four_sized_vector_double) {
    double actual = Maths::median(four_sized_vector_double.begin(), four_sized_vector_double.end());
...
TEST(MathsTest, mode___vector_with_two_values_random_order_same_amount_return_smallest_int) {

...
TEST_F(VCFTest___merge_multi_allelic_core___Fixture, merged_VCF_is_not_initially_empty)
{
    ...
    ASSERT_EXCEPTION(vcf.merge_multi_allelic_core(merged_vcf, 10000), FatalRuntimeError,
...
TEST_F(VCFTest___header___Fixture, header)
{
    std::string expected
        = "##fileformat=VCFv4.3\n"
          ...
          "##FORMAT=<ID=MEAN_FWD_COVG,Number=R,Type=Integer,Description=\"Mean forward "
          "coverage\">\n"
          "##FORMAT=<ID=MEAN_REV_COVG,Number=R,Type=Integer,Description=\"Mean reverse "
          "coverage\">\n"
          "##FORMAT=<ID=MED_FWD_COVG,Number=R,Type=Integer,Description=\"Med forward "
          "coverage\">\n"
          "##FORMAT=<ID=MED_REV_COVG,Number=R,Type=Integer,Description=\"Med reverse "
          "coverage\">\n"
          "##FORMAT=<ID=SUM_FWD_COVG,Number=R,Type=Integer,Description=\"Sum forward "
          "coverage\">\n"
          "##FORMAT=<ID=SUM_REV_COVG,Number=R,Type=Integer,Description=\"Sum reverse "
          "coverage\">\n"

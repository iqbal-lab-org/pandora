...
#bash ../../../header.sh &> test_oxa9_5.15.500.log
#../../../build/pandora map -p $prg -r oxa9_read.fasta -o test_oxa9_5.15.500 -m 500 -e 0.0001 -w 5 &>> test_oxa9_5.15.500.log
...
#bash ../../../header.sh &> test_JR_5.15.500.log
#../../../build/pandora map -p $prg -r JR_FAA63668_14102015_kpne_CAV1596_reads.fasta -o test_JR_5.15.500 -m 500 -w 5 &>> test_JR_5.15.500.log
...
bash ../../../header.sh &> test_all2d_JR_5.15.500.log
perf record ../../../build/pandora map -p $prg -r JR_FAA63668_14102015_kpne_CAV1596_all2d_reads.fasta -o test_all2d_JR_5.15.500 -m 500 -w 5 &>> test_all2d_JR_5.15.500.log

...
TEST(GeneIntervalInfoTest, create) {
    ...
    auto node_id = 3;
    auto name = "dummy";
    auto pn_ptr = std::make_shared<pangenome::Node>(prg_id, node_id, name);
...
TEST(GeneIntervalInfoTest, less_than) {
    ...
    auto pn1_ptr = std::make_shared<pangenome::Node>(prg_id, node_id, name);
    PanNodePtr pn2_ptr = nullptr;

    prg_id = 5;
    node_id = 2;
    auto pn3_ptr = std::make_shared<pangenome::Node>(prg_id, node_id, name);

    prg_id = 4;
    auto pn4_ptr = std::make_shared<pangenome::Node>(prg_id, node_id, name);

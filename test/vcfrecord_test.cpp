...
//    EXPECT_EQ(vr.get_format_u(0, "hello")[0], std::numeric_limits<uint16_t>::max() -
//    1);
//}
//
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ostream methods
// ALL ostream TESTS WERE REPLACED BY to_string TESTS - MUCH OF THE COMPLEXITY HERE WAS
// MOVED TO OTHER METHODS/CONCEPTS e.g. VCFRecord::alts_to_string(),
// VCFRecord::get_format(), SampleIndexToSampleInfo::to_string(),
// SampleInfo::to_string(), etc...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//    "GT:pringle"}; vector<uint16_t> vu = {0, 2}; stringstream out; out << vr; string
//    rr; for (const auto &s : v) {
//        out >> rr;
//        EXPECT_EQ(s, rr);
//    }
//    uint ru;
...
//    vr.add_formats({"pringle"});
//    vector<string> v = {"chrom1", "4", ".", "A", "T", ".", ".", "SVTYPE=SNP",
//    "GT:pringle"}; vector<uint16_t> vu = {0}; stringstream out; out << vr; string rr;
//    for (const auto &s : v) {
//        out >> rr;
//        EXPECT_EQ(s, rr);
//    }

...
/*TEST(VCFRecordSwapTest, swaps_correctly_all_values_present) {
    ...
    vr.regt_samples[0]["REF_LIKELIHOOD"] = 12;
    vr.regt_samples[0]["ALT_LIKELIHOOD"] = 13;
    vr.samples[0]["GT"] = 14;
    vr.regt_samples[0]["CONFIDENCE"] = 15;

    vr.swap_ref_and_alt_properties(0);
    ...
    EXPECT_EQ(vr.regt_samples[0]["REF_LIKELIHOOD"],13);
